...
const resources: Translation['resources'] = {
  ...
  [RESOURCES.ORDER]: {
    ...
    hisReportStatusMessage: `{status|{${HIS_REPORT_STATUS_TYPE.FAILED}: Failed,${HIS_REPORT_STATUS_TYPE.NOT_READY}: Not Ready,${HIS_REPORT_STATUS_TYPE.SENDING}: Sending, ${HIS_REPORT_STATUS_TYPE.SUCCEEDED}: Succeeded}}`,
    signStatusMessage: {
      unSigned: 'Unsigned',
      signed: 'Signed',
    },
  ...
  [RESOURCES.TIMETABLE]: {
    ...
    nextDay: 'Next day',
    weekday:
      '{weekday|{1: Monday, 2: Tuesday, 3: Wednesday, 4: Thusday, 5: Friday, 6: Saturday, 7: Sunday}}',
  },
