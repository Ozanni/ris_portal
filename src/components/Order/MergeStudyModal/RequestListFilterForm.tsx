...
export const RequestListFilterForm: FC<RequestListFilterFormProps> = (props) => {
  ...
  const formOptions: UseFormProps<ISearchOrderFilter> = {
    ...
    defaultValues: {
      patientName: query.filter.patientName ?? EMPTY_VALUES.patientName,
      pidSuffix: query.filter.pidSuffix ?? EMPTY_VALUES.pidSuffix,
      requestedDateFrom: query.filter.requestedDateFrom ?? EMPTY_VALUES.requestedDateFrom,
      requestedDateTo: query.filter.requestedDateTo ?? EMPTY_VALUES.requestedDateTo,
    },
  };
